                  ...
                  <div className="geo-position-section d-flex flex-column my-4">
                    ...
                    <div className="d-flex flex-column flex-md-row mb-0 mb-md-3">
                      <div className="input mb-3 mb-md-0 me-0 me-md-2">
                        ...
                        <input type="number" className="form-control" id="latitude" aria-describedby="latitude input field" min="-90" max="90" step="0.0001" placeholder="Latitude" value={latitude} onChange={(e) => setRequestLatitude(e.target.value)} required />
                      </div>
                      <div className="input mb-3 mb-md-0 ms-0 ms-md-2">
                        ...
                        <input type="number" className="form-control" id="longitude" aria-describedby="longitude input field" min="-180" max="180" step="0.0001" placeholder="Longitude" value={longitude} onChange={(e) => setRequestLongitude(e.target.value)} required />
                      </div>
                    </div>
