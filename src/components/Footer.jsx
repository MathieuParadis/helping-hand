  ...
  return (
    <div className="footer">
      <div className="d-flex flex-column flex-lg-row justify-content-between align-items-center">
        <img src={logo} alt="Helping Hand logo" className="logo mb-4 mb-lg-0" />
        <div className="d-none d-md-block align-self-lg-start col-7 col-xl-8 mb-4 mb-lg-0">
          ...
          <p className="mb-0 text-justify">
            ...
            We aim to educate, and inspire people to embrace kindness and charitable giving, and in doing so, be the change they want to see in the world.
