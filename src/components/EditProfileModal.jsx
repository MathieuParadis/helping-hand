                ...
                <div className="geo-position-section d-flex flex-column my-4">
                  ...
                  <div className="d-flex flex-column flex-md-row mb-0 mb-md-3">
                    <div className="input mb-3 mb-md-0 me-0 me-md-2">
                      ...
                      <input type="number" className="form-control" id="latitude-user-profile" aria-describedby="latitude input field" min="-90" max="90" placeholder="Latitude" step="0.0001" value={lat} onChange={(e) => setLat(e.target.value)} required />
                    ...
                    <div className="input mb-3 mb-md-0 ms-0 ms-md-2">
                      ...
                      <input type="number" className="form-control" id="longitude-user-profile" aria-describedby="longitude input field" min="-180" max="180" placeholder="Longitude" step="0.0001" value={long} onChange={(e) => setLong(e.target.value)} required />
                      <img src={position_icon} alt="position icon" className="position-icon" />
                    </div>
                  </div>
